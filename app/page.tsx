...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'Session earnings are released quickly and transparently. No waiting weeks, no opaque fee structures. Your rate is your rate — end of conversation.',
  },
  {
  ...
  },
  {
    ...
    body: 'Set your own session modality when you apply. Work from your city, from home, or anywhere with a connection. Change your settings any time from your dashboard.',
  },
  {
  ...
  {
    title: 'Gold Verified & Licensed badge',
    body: 'Pass our review and earn the gold ✦ Verified & Licensed badge. Dreamers trust it on arrival — before they read a single word of your bio.',
  },
  {
    title: 'Real analytics — not guesswork',
    body: 'See profile views, story saves, and returning dreamers from your companion dashboard. Understand what resonates, then grow with data, not gut feeling.',
  },
]
    ...
    <div className="mb-4">
      ...
      {showError && (
        <p className="text-[12px] mt-1.5 animate-fade-in" style={{ color: '#f87171' }}>
          ...
          {!['IN', 'GB', 'US'].includes(countryCode) &&
            `Enter a valid ${maxDigits}-digit number for this country`}
        </p>
      )}
...
function ApplyForm() {
  ...
  const whatsappFull =
    dialCode && whatsappNum ? `${dialCode}${whatsappNum.replace(/^0+/, '')}` : whatsappNum
  ...
  async function verifyOtpAuto(otp: string) {
    ...
    setLoading(true)
    try {
      const r = await fetch('/api/companions/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  function step2Next() {
    ...
    if (!valid) {
      setError('Enter a valid WhatsApp number for your country.')
      return
    }
  ...
  async function submitApplication() {
    ...
    if (!gender) {
      setError('Select your gender identity.')
      return
    }
    if (!tagline.trim()) {
      setError('Write a vibe headline.')
      return
    }
    if (!bio.trim()) {
      setError('Write something about yourself.')
      return
    }
    if (!modality) {
      setError('Select your session type.')
      return
    }
    setLoading(true)
    try {
      ...
      <div className="px-6 pt-7 pb-8 sm:px-8">
        ...
        {step === 1 && (
          <div key={`s1-${animKey}`} className="animate-fade-up">
            <p
              className="text-[11px] uppercase tracking-[0.1em] mb-1.5"
              style={{ color: '#6b7280' }}
            >
              Step 1 of 3
            </p>
            ...
            {!otpSent ? (
              <>
                ...
                <p className="text-[11px] -mt-2 mb-5" style={{ color: '#4b5563' }}>
                  Must be 18 or older. Never shown publicly.
                </p>
              ...
              <div key={`otp-${animKey}`} className="animate-fade-up">
                ...
                {loading && (
                  <p
                    className="text-center text-[13px] mb-4 animate-pulse"
                    style={{ color: '#6b7280' }}
                  >
                    Verifying…
                  </p>
            ...
            {dialCode && (
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[12px]" style={{ color: '#4b5563' }}>
                  country code prepended automatically
                </span>
              </div>
            )}
            <PhoneInput
        ...
        {step === 3 && (
          <div key={`s3-${animKey}`} className="animate-fade-up">
            ...
            <p className="text-[14px] leading-relaxed mb-6" style={{ color: '#6b7280' }}>
              How dreamers will first meet you. Write as if you are whispering into someone&rsquo;s
              ear.
            </p>
            ...
            {photoPreview ? (
              ...
              <div
                ...
                onDragOver={(e) => {
                  e.preventDefault()
                  ;(e.currentTarget as HTMLElement).style.borderColor = 'rgba(232,96,122,0.5)'
                }}
                onDragLeave={(e) => {
            ...
            />
            <p className="text-[11px] mb-5" style={{ color: '#4b5563' }}>
              A clear photo helps our review team — not shown publicly until you go live.
            </p>
            ...
            <label className="block text-[12px] mb-2" style={{ color: '#9ca3af' }}>
              Gender identity
            </label>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {MODALITIES.map((m) => (
                <Pill
                  ...
                  current={modality}
                  label={m.label}
                  onClick={() => setModality(m.v === modality ? '' : m.v)}
                />
              ))}
            </div>
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            style={{
              color: '#e8607a',
              background: 'rgba(232,96,122,.1)',
              border: '1px solid rgba(232,96,122,.28)',
              textDecoration: 'none',
            }}
          >
            Apply now
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-5 pt-28 pb-20">
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(rgba(232,96,122,.05) 1px,transparent 1px),linear-gradient(90deg,rgba(232,96,122,.05) 1px,transparent 1px)',
            backgroundSize: '60px 60px',
            WebkitMaskImage:
              'radial-gradient(ellipse 85% 85% at 50% 50%,black 25%,transparent 80%)',
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 72% 58% at 50% 28%,rgba(232,96,122,.07) 0%,transparent 70%)',
          }}
        />
        <div className="relative z-10 animate-fade-up">
          ...
          <p
            className="text-[15px] leading-[1.75] max-w-[440px] mx-auto mb-10"
            style={{ color: '#6b7280' }}
          >
      ...
      <div id="why-join">
        <div className="max-w-[1100px] mx-auto px-5 py-16 sm:py-20">
          ...
          <p
            className="text-[15px] leading-[1.75] max-w-[500px] mb-10"
            style={{ color: '#6b7280' }}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 mb-6">
            {FEATURES.map((f) => (
              ...
              >
                ...
                <div className="text-[14px] font-medium" style={{ color: '#eeeef0' }}>
                  {f.title}
                </div>
                <div className="text-[13px] leading-[1.75]" style={{ color: '#6b7280' }}>
                  {f.body}
                </div>
              </div>
            ))}
          ...
          >
            <div>
              ...
              <p className="text-[13px] leading-[1.8]" style={{ color: '#6b7280' }}>
                Once approved, you get access to a full companion dashboard — everything you need to
                build a presence, attract dreamers, and run your sessions your way. Write stories.
                Upload photos and video. Watch your analytics grow.
              </p>
            </div>
            <div>
          ...
          {[
            {
              ...
              body: 'Fill out a short application — your details, your vibe, an optional photo. No lengthy forms. No waiting rooms. Just you, your words, and a button.',
            },
            {
              title: 'Personal review',
              body: 'Every application is reviewed by our team within 24–48 hours. We look at your profile holistically. You will get an email either way.',
            },
            {
              title: 'Build your profile',
              body: 'Once approved, log in to your companion dashboard. Upload photos and videos, write your stories, set your session cards, and define your pricing.',
            },
            {
            ...
            >
              ...
              <div>
                <div className="text-[16px] font-medium mb-1.5" style={{ color: '#eeeef0' }}>
                  {s.title}
                </div>
                <div className="text-[13px] leading-[1.75]" style={{ color: '#6b7280' }}>
                  {s.body}
      ...
      <div id="apply" className="max-w-[620px] mx-auto px-5 py-16 sm:py-20">
        <p
          className="text-[11px] uppercase tracking-[0.1em] mb-2 text-center"
          style={{ color: '#6b7280' }}
        >
          Apply now
        </p>
        ...
        <p className="text-center text-[12px] mt-5" style={{ color: '#4b5563' }}>
          Already approved?{' '}
          <a href="/login" style={{ color: '#e8607a', textDecoration: 'none' }}>
